...
volatile long previouscount1=0;
volatile long previouscount2=0;
...
void loop() {
    ...
    if(currentmillis-previousmillis>1000/30){
      msg.x=count1-previouscount1;
      msg.y=count2-previouscount2;
      msg.z=0;
      RCSOFTCHECK(rcl_publish(&publisher, &msg, NULL));
      RCCHECK(rclc_executor_spin_some(&executor, RCL_MS_TO_NS(100)));
      previousmillis=currentmillis;
      previouscount1=count1;
      previouscount1=count2;
    }

    if(msg1.x>0 && msg1.y>0){
